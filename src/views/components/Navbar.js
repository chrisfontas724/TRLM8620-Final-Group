...
let Navbar = {
    render: async () => {
        ...
        let localeJP = i18n.getString("LocaleSelector", "localeJP");
        ...
        <section id="headOptions">
            ...
            <div class="localeSelector">
              ...
              <select id="locale" class="hamDrop">
                ...
                <option value="ja-JP">${localeJP}</option>
              </select>
            </div>
        </section>
    </header>
    <nav>
        ...
        <ul>
            ...
            <li><a href="./#/games" class="navLink" id="games">${navLinkGames}</a></li>
            <li><a href="./#/hardware" class="navLink" id="hardware">${navLinkHardware}</a></li>
        </ul>
    </nav>
    `;
        return view
